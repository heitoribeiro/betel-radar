const CACHE='betel-radar-v0.8.2-github-8243';
const ASSETS=[
...
self.addEventListener('fetch',event=>{
  ...
  const noCacheFiles=[
    ...
    'v082-dashboard-crm-authority.js','v082-radar-cleanup.js','v082-mobile-menu-fix.js','v082-desktop-layout-fix.js','v082-visual-polish.js','v082-funnel-crm-sync.js','v082-map-agenda-final-fix.js','v082-agenda-today-dedup.js','v082-contacts-hub.js','logo-br.svg'
  ];
