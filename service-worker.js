const CACHE='betel-radar-v0.8.2-github-8231';
const ASSETS=[
  ...
  './v082-real-data.js','./v082-sync.js','./v082-map-data-bridge.js','./v082-opportunity-detail.js','./v082-admin-tools.js','./v082-data-correction.js','./v082-prospecting.js','./v082-detail-layout-fix.js','./v082-detail-data-guard.js','./v082-ui-stability.js','./v082-dashboard-crm-authority.js','./v082-radar-cleanup.js','./logo-br.svg'
];
...
self.addEventListener('fetch',event=>{
  ...
  const noCacheFiles=[
    'v080.js','v081-mobile-fix.js','header-fix.js','v082-auth-bootstrap.js','v082-auth-session.js','v082-app-loader.js',
