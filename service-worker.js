const CACHE='betel-radar-v0.8.2-github-8240';
const ASSETS=[
...
self.addEventListener('fetch',event=>{
  ...
  const noCacheFiles=[
    ...
    'v082-dashboard-crm-authority.js','v082-radar-cleanup.js','v082-mobile-menu-fix.js','v082-desktop-layout-fix.js','v082-visual-polish.js','v082-funnel-crm-sync.js','logo-br.svg'
  ];
