const CACHE='betel-radar-v0.8.2-github-8235';
const ASSETS=[
...
self.addEventListener('fetch',event=>{
  ...
  const noCacheFiles=[
    ...
    'v082-dashboard-crm-authority.js','v082-radar-cleanup.js','v082-mobile-menu-fix.js','logo-br.svg'
  ];
