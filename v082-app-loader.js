/* Betel Radar v0.8.2 — carregador pós-login estável, build 8245 */
(function(){
  'use strict';
  ...
  async function loadApplication(){
    ...
    html=html
      ...
      .replace("navigator.serviceWorker.register('/service-worker.js')","navigator.serviceWorker.register('./service-worker.js?v=8245')")
      .replace("navigator.serviceWorker.register('./service-worker.js')","navigator.serviceWorker.register('./service-worker.js?v=8245')");
    ...
    const patchTag=
      ...
      '<scr'+'ipt src="./v082-olx-official.js?v=8245&nocache=1"></scr'+'ipt>';
