/* Betel Radar v0.8.2 — carregador pós-login estável, build 8242 */
(function(){
  'use strict';
  ...
  async function loadApplication(){
    ...
    html=html
      ...
      .replace("navigator.serviceWorker.register('/service-worker.js')","navigator.serviceWorker.register('./service-worker.js?v=8242')")
      .replace("navigator.serviceWorker.register('./service-worker.js')","navigator.serviceWorker.register('./service-worker.js?v=8242')");
