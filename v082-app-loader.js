/* Betel Radar v0.8.2 — carregador pós-login estável, build 8237 */
(function(){
  'use strict';
  ...
  async function loadApplication(){
    ...
    html=html
      ...
      .replace("navigator.serviceWorker.register('/service-worker.js')","navigator.serviceWorker.register('./service-worker.js?v=8237')")
      .replace("navigator.serviceWorker.register('./service-worker.js')","navigator.serviceWorker.register('./service-worker.js?v=8237')");
    ...
    const patchTag=
      ...
      '<scr'+'ipt src="./v082-desktop-layout-fix.js?v=8237&nocache=2"></scr'+'ipt>'+
