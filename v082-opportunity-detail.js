/* Betel Radar v0.8.2 — ficha de origem e verificação, build 8209 */
(function(){
  const BUILD='8209';
  let currentId=null;
  ...
  function installStyles(){
    ...
    const s=document.createElement('style');s.id='v082OpportunityDetailStyles';s.textContent=`
      ...
      @media(max-width:760px){
        ...
        .v082-origin-head{display:block}.v082-origin-badges{justify-content:flex-start;margin-top:8px}.v082-origin-grid,.v082-origin-check ul{grid-template-columns:1fr}.v082-origin-actions{display:grid;grid-template-columns:1fr}.v082-origin-btn{text-align:center;width:100%;box-sizing:border-box;padding:10px}.v082-origin-title{font-size:13px}.v082-origin-sub{font-size:10px}
      }
